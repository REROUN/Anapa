...
//            val rightHip = pose.getPoseLandmark(PoseLandmark.RIGHT_HIP)
            ...
            var rightHipY=0.0F
            if (leftHombro != null && leftCadera != null) {
                modifiedRightHipX = leftHombro.getPosition().x
                rightHipY = leftCadera.getPosition().y
            }
...
//            ) / 180 * 100
                        val rightHipAngle = getAngle3D(
                            ...
                            leftHombro!!.getPosition3D(),
                            leftMuñeca!!.getPosition3D()
                        )
...
//      drawLine(canvas, rightRodilla, rightTobillo, rightPaint)
            ...
            canvas.drawLine(translateX(leftHombro!!.position3D.x), translateY(leftHombro!!.position3D.y), translateX(300.0f),
                translateY(leftHombro!!.position3D.y), rightPaint)
